...
namespace Sistema
{
    public partial class VentanaClientes : Form
    {
        ...
        {
            instanciaConexion.ejecutarTransaccion("Clientes","INSERT INTO Clientes VALUES("+textBox1.Text+",'"+textBox2.Text+"',"+textBox3.Text+",'"+textBox4.Text+"');",Form1.usuarioInstanciado,"Insertar");
        }

        private void button2_Click(object sender, EventArgs e)
        {
            instanciaConexion.ejecutarTransaccion("Clientes","DELETE FROM Clientes WHERE(NIT="+textBox1.Text+");",Form1.usuarioInstanciado,"Eliminar");
        }

        private void button3_Click(object sender, EventArgs e)
        {
            instanciaConexion.ejecutarTransaccion("Clientes","UPDATE Clientes SET NIT="+textBox1.Text+",Nombre='"+textBox2.Text+"',Telefono="+textBox3.Text+",Direccion='"+textBox4.Text+"' WHERE NIT="+textBox1.Text+";",Form1.usuarioInstanciado,"Modificar");
        }
    }
}
